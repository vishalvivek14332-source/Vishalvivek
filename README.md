...
AI-powered system using Computer Vision and Machine Learning to recognize sign language gestures and convert them into text and speech.

### 🤖 Machine Learning Projects

Exploring predictive models, classification systems, and intelligent automation.

### 🌐 IoT-Based Smart Solutions

Developing IoT applications integrated with AI for real-world use cases.
